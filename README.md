...
| # | Title | Champ. | Supporters | Against | 👍 | 🕙 |
|--:|:------|:------:|:-----------|:--------|---:|:--:|
| [#16196](https://github.com/eslint/eslint/pull/16196) | feat: `no-restricted-imports` option added `allowImportNames` |  | <img alt="@mdjermanovic" src="https://github.com/mdjermanovic.png" width="32px" height="32px"> |  | 2 | ⌛ 2022-09-02 |
